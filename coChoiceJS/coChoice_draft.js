...
startSequence: function(){
  ...
  _this = this
  setTimeout(function(){_this.displayGrid()}, 1500)
},
...
displayGrid: function(){
  ...
  var _this = this
  setTimeout(function(){_this.endTrial()}, 3000)
},
...
endTrial: function(){
  ...
  if(this.response_key_1 == '' || this.response_key_2 == ''){
    ...
    //set response variables to 'NaN'
    if(this.response_key_1 == '' && this.response_key_2 == ''){
      this.response_key_1 = 'NaN'
      this.shape_choice_1 = 'NaN'
      this.shape_position_1 = 'NaN'

      this.response_key_2 = 'NaN'
      this.shape_choice_2 = 'NaN'
      this.shape_position_2 = 'NaN'
    }
    else{
      this.response_key_2 = "NaN"
      this.shape_choice_2 = "NaN"
